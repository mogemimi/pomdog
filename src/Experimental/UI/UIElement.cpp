...
void UIElement::OnTextInput(const KeyboardState&, const std::string&)
{
}

void UIElement::OnKeyDown(const KeyboardState&, Keys)
{
}

void UIElement::OnKeyUp(const KeyboardState&, Keys)
{
}
