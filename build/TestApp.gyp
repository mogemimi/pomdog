  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '../test/TestApp/Skeletal2D/AnimationAdditiveNode.cpp',
        '../test/TestApp/Skeletal2D/AnimationAdditiveNode.hpp',
        '../test/TestApp/Skeletal2D/AnimationBlendInput.hpp',
        '../test/TestApp/Skeletal2D/AnimationBlendInputType.hpp',
        ...
        '../test/TestApp/Skeletal2D/AnimationGraphWeightCollection.hpp',
        '../test/TestApp/Skeletal2D/AnimationKeyHelper.hpp',
        '../test/TestApp/Skeletal2D/AnimationLerpNode.cpp',
        '../test/TestApp/Skeletal2D/AnimationLerpNode.hpp',
        '../test/TestApp/Skeletal2D/AnimationNode.hpp',
        ...
        '../test/TestApp/Skeletal2D/SkeletonPose.cpp',
        '../test/TestApp/Skeletal2D/SkeletonPose.hpp',
        '../test/TestApp/Skeletal2D/SkeletonTransform.hpp',
        ...
        '../test/TestApp/UI/HorizontalAlignment.hpp',
        ...
        '../test/TestApp/UI/UIEventDispatcher.cpp',
        '../test/TestApp/UI/UIEventDispatcher.hpp',
        '../test/TestApp/UI/UIEventListener.hpp',
        '../test/TestApp/UI/UIHelper.hpp',
        '../test/TestApp/UI/UIView.cpp',
        '../test/TestApp/UI/UIView.hpp',
        '../test/TestApp/UI/VerticalAlignment.hpp',
        '../test/TestApp/UI/detail/SubscribeRequestDispatcher.hpp',
        '../test/TestApp/UI/detail/UIEventConnection.hpp',
        '../test/TestApp/Graphics/FXAA.cpp',
        '../test/TestApp/Graphics/FXAA.hpp',
        '../test/TestApp/Graphics/LineBatch.cpp',
        '../test/TestApp/Graphics/LineBatch.hpp',
        '../test/TestApp/Graphics/PolygonBatch.cpp',
        '../test/TestApp/Graphics/PolygonBatch.hpp',
        ...
        '../test/TestApp/2D/SpriteRenderable.hpp',
        '../test/TestApp/Rendering/ParticleBatchCommand.cpp',
        '../test/TestApp/Rendering/ParticleBatchCommand.hpp',
        '../test/TestApp/Rendering/RenderCommand.hpp',
        '../test/TestApp/Rendering/Renderer.cpp',
        '../test/TestApp/Rendering/Renderer.hpp',
        '../test/TestApp/Rendering/RenderQueue.cpp',
