  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '../test/TestApp/2D/BeamRenderer.cpp',
        '../test/TestApp/2D/BeamRenderer.hpp',
        '../test/TestApp/2D/RenderCommand.hpp',
        '../test/TestApp/2D/RenderQueue.cpp',
        '../test/TestApp/2D/RenderQueue.hpp',
        '../test/TestApp/2D/Renderer.hpp',
        '../test/TestApp/2D/SkinnedMeshRenderer.cpp',
        '../test/TestApp/2D/SkinnedMeshRenderer.hpp',
