  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        '../test/TestApp/LineRenderer.cpp',
        '../test/TestApp/LineRenderer.hpp',
        ...
        '../test/TestApp/SpriteFont.cpp',
        '../test/TestApp/SpriteFont.hpp',
        '../test/TestApp/SpriteFontLoader.cpp',
        '../test/TestApp/SpriteFontLoader.hpp',
        '../test/TestApp/SpriteLine.cpp',
        '../test/TestApp/SpriteLine.hpp',
        '../test/TestApp/SpriteSortMode.hpp',
