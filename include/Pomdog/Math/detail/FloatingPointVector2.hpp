...
#ifndef POMDOG_MATH_DETAIL_FLOATINGPOINTVECTOR2_HPP
#define POMDOG_MATH_DETAIL_FLOATINGPOINTVECTOR2_HPP
...
#endif // !defined(POMDOG_MATH_DETAIL_FLOATINGPOINTVECTOR2_HPP)
