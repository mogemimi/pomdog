...
[[nodiscard]] Point2D
toPoint2D(const NSPoint& point, const NSSize& bounds)
{
...
[[nodiscard]] Keys
translateKey(pomdog::u16 keyCode)
{
    constexpr std::array<Keys, 127> keyTable = {
        ...
        Keys::Digit1,          // 0x12: kVK_ANSI_1
        Keys::Digit2,          // 0x13: kVK_ANSI_2
        Keys::Digit3,          // 0x14: kVK_ANSI_3
        Keys::Digit4,          // 0x15: kVK_ANSI_4
        Keys::Digit6,          // 0x16: kVK_ANSI_6
        Keys::Digit5,          // 0x17: kVK_ANSI_5
        Keys::Equals,          // 0x18: kVK_ANSI_Equal
        Keys::Digit9,          // 0x19: kVK_ANSI_9
        Keys::Digit7,          // 0x1A: kVK_ANSI_7
        Keys::Minus,           // 0x1B: kVK_ANSI_Minus
        Keys::Digit8,          // 0x1C: kVK_ANSI_8
        Keys::Digit0,          // 0x1D: kVK_ANSI_0
        ...
        Keys::Backquote,       // 0x32: kVK_ANSI_Grave
        ...
        Keys::NumpadDecimal,   // 0x41: kVK_ANSI_KeypadDecimal
        Keys::Unknown,         // 0x42:
        Keys::NumpadMultiply,  // 0x43: kVK_ANSI_KeypadMultiply
        Keys::Unknown,         // 0x44:
        Keys::NumpadAdd,       // 0x45: kVK_ANSI_KeypadPlus
        Keys::Unknown,         // 0x46:
        Keys::Clear,           // 0x47: kVK_ANSI_KeypadClear
        Keys::AudioVolumeUp,   // 0x48: kVK_VolumeUp
        Keys::AudioVolumeDown, // 0x49: kVK_VolumeDown
        Keys::AudioVolumeMute, // 0x4A: kVK_Mute
        Keys::NumpadDivide,    // 0x4B: kVK_ANSI_KeypadDivide
        Keys::Enter,           // 0x4C: kVK_ANSI_KeypadEnter
        Keys::Unknown,         // 0x4D:
        Keys::NumpadSubtract,  // 0x4E: kVK_ANSI_KeypadMinus
        Keys::F18,             // 0x4F: kVK_F18
        Keys::F19,             // 0x50: kVK_F19
        Keys::Equals,          // 0x51: kVK_ANSI_KeypadEquals
        Keys::Numpad0,         // 0x52: kVK_ANSI_Keypad0
        Keys::Numpad1,         // 0x53: kVK_ANSI_Keypad1
        Keys::Numpad2,         // 0x54: kVK_ANSI_Keypad2
        Keys::Numpad3,         // 0x55: kVK_ANSI_Keypad3
        Keys::Numpad4,         // 0x56: kVK_ANSI_Keypad4
        Keys::Numpad5,         // 0x57: kVK_ANSI_Keypad5
        Keys::Numpad6,         // 0x58: kVK_ANSI_Keypad6
        Keys::Numpad7,         // 0x59: kVK_ANSI_Keypad7
        Keys::F20,             // 0x5A: kVK_F20
        Keys::Numpad8,         // 0x5B: kVK_ANSI_Keypad8
        Keys::Numpad9,         // 0x5C: kVK_ANSI_Keypad9
        Keys::IntlYen,         // 0x5D: kVK_JIS_Yen
...
translateKeyToModifierFlag(Keys key)
{
    switch (key) {
    case Keys::CapsLock:
