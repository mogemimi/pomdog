...
#include "shaders/glsl.embedded/chromatic_aberration_ps.inc.hpp"
#include "shaders/glsl.embedded/screen_quad_vs.inc.hpp"
#endif
#if defined(POMDOG_PLATFORM_WIN32)
#include "shaders/hlsl.embedded/chromatic_aberration_ps.inc.hpp"
#include "shaders/hlsl.embedded/screen_quad_vs.inc.hpp"
#endif
#if defined(POMDOG_PLATFORM_MACOSX)
#include "shaders/metal.embedded/chromatic_aberration_ps.inc.hpp"
    ...
    AssetManager& assets)
{
    ...
    pixelShaderBuilder.SetGLSL(Builtin_GLSL_ChromaticAberration_PS, std::strlen(Builtin_GLSL_ChromaticAberration_PS));
#endif
#if defined(POMDOG_PLATFORM_WIN32)
    vertexShaderBuilder.SetHLSLPrecompiled(BuiltinHLSL_ScreenQuad_VS, sizeof(BuiltinHLSL_ScreenQuad_VS));
    pixelShaderBuilder.SetHLSLPrecompiled(BuiltinHLSL_ChromaticAberration_PS, sizeof(BuiltinHLSL_ChromaticAberration_PS));
#endif
#if defined(POMDOG_PLATFORM_MACOSX)
    vertexShaderBuilder.SetMetal(Builtin_Metal_ScreenQuad_VS, std::strlen(Builtin_Metal_ScreenQuad_VS), "ScreenQuadVS");
    pixelShaderBuilder.SetMetal(Builtin_Metal_ChromaticAberration_PS, std::strlen(Builtin_Metal_ChromaticAberration_PS), "ChromaticAberrationPS");
#endif
