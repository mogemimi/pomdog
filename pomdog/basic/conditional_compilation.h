...
// NOTE: Visual Studio 2026 or later (_MSC_VER >= 1950)
#if _MSC_VER >= 1950
#define POMDOG_MSVC_SUPPRESS_WARNING_1950(w) __pragma(warning(disable : w))
#else
#define POMDOG_MSVC_SUPPRESS_WARNING_1950(w)
#endif

// NOTE: Visual Studio 2026 or later (_MSC_VER >= 1951)
#if _MSC_VER >= 1951
#define POMDOG_MSVC_SUPPRESS_WARNING_1951(w) __pragma(warning(disable : w))
#else
#define POMDOG_MSVC_SUPPRESS_WARNING_1951(w)
#endif
...
#define POMDOG_SUPPRESS_WARNINGS_GENERATED_BY_STD_HEADERS_BEGIN      \
    ...
    POMDOG_MSVC_SUPPRESS_WARNING_1950(4865)                          \
