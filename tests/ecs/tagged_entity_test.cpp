...
#include "pomdog/ecs/tagged_entity.h"
...
using pomdog::ecs::TaggedEntity;
} // namespace

TEST_CASE("TaggedEntity")
{
    struct MobTag final {};
    struct ItemTag final {};

    using Mob = TaggedEntity<MobTag>;
    using Item = TaggedEntity<ItemTag>;

    static_assert(sizeof(Mob) == sizeof(Entity));
    static_assert(sizeof(Item) == sizeof(Entity));
    ...
    {
        Mob e{Entity{u32(0x3FFFFul), 12345}};
    ...
    SUBCASE("0x3FFF edge")
    {
        Mob e{Entity{12345, u16(0x3FFFul)}};
