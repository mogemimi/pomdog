...
TEST_CASE("MathFunctions", "[MathFunctions]")
{
    ...
    SECTION("ToDegrees")
    {
        ...
        REQUIRE(std::abs(0.0f - math::toDegrees(Radian<f32>(0.0f)).value) < epsilon);
        REQUIRE(std::abs(45.0f - math::toDegrees(Radian<f32>(0.7853981633f)).value) < epsilon);
        REQUIRE(std::abs(90.0f - math::toDegrees(Radian<f32>(1.5707963267f)).value) < epsilon);
        REQUIRE(std::abs(180.0f - math::toDegrees(Radian<f32>(3.1415926535f)).value) < epsilon);
        REQUIRE(std::abs(360.0f - math::toDegrees(Radian<f32>(6.2831853071f)).value) < epsilon);
    }
    SECTION("ToRadians")
    {
        ...
        REQUIRE(std::abs(0.0f - math::toRadians(Degree<f32>(0.0f)).value) < epsilon);
        REQUIRE(std::abs(0.7853981633f - math::toRadians(Degree<f32>(45.0f)).value) < epsilon);
        REQUIRE(std::abs(1.5707963267f - math::toRadians(Degree<f32>(90.0f)).value) < epsilon);
        REQUIRE(std::abs(3.1415926535f - math::toRadians(Degree<f32>(180.0f)).value) < epsilon);
        REQUIRE(std::abs(6.2831853071f - math::toRadians(Degree<f32>(360.0f)).value) < epsilon);
    }
}
