...
target_sources(pomdog_static PRIVATE
    ...
    $<$<PLATFORM_ID:Linux>:
        ...
        ${POMDOG_SRC_DIR}/platform/x11/opengl_context_x11.h
    >
    ...
    $<$<PLATFORM_ID:Windows>:
        ...
        ${POMDOG_SRC_DIR}/platform/win32/bootstrap_settings_win32.h
    ...
    $<$<AND:$<PLATFORM_ID:Windows>,$<BOOL:${POMDOG_USE_GL4}>>:
        ...
        ${POMDOG_SRC_DIR}/platform/win32/opengl_context_win32.h
    >
)
